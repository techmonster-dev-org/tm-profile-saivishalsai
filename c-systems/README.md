...
**saivishalsai** · [← Back to profile](../README.md) · Updated 2026-09-11

## Progress

[█░░░░░░░░░░░░░░░░░░░] 6%   (3 of 48 projects completed)

## C Foundations & the Toolchain

| Project | Score | Understanding | Reviewed | Feedback |
|---|---|---|---|---|
| Explore C's fundamental types, use sizeof and <limits.h> to inspect platform sizes and bounds, use <stdint.h> fixed-width types, and understand why signed overflow is undefined behavior while unsigned wraparound is not. | ✅ Pass | ✅ Verified | 2026-09-01 | [→](https://github.com/techmonster-dev-org/tm-student-saivishalsai-c-systems/issues/8) |
...
| Master C's arithmetic, comparison, logical, and bitwise operators, understand operator precedence traps, and implement the set/test/clear/toggle bit-manipulation patterns used in every device driver and systems library. | ⏳ Needs work | ⚠️ Unverified | 2026-08-24 | [→](https://github.com/techmonster-dev-org/tm-student-saivishalsai-c-systems/issues/4) |
...
| Write your first C program, trace the four-stage gcc compilation pipeline (preprocess/compile/assemble/link), and understand why C produces tiny, fast native binaries. | ⏳ Needs work | ⚠️ Unverified | 2026-08-25 | — |
...
| Build a growable heap array using the double-capacity realloc strategy, manage arrays of structs with owned string fields, implement deep vs shallow copy, and verify zero leaks with Valgrind. | ⏳ Needs work | ⚠️ Unverified | 2026-09-11 | [→](https://github.com/techmonster-dev-org/tm-student-saivishalsai-c-systems/issues/14) |
| Compare stack vs heap lifetime by printing their addresses, then use malloc/calloc/realloc/free to manage dynamic arrays and return heap memory from a function with documented ownership transfer. | ⏳ Needs work | ⚠️ Unverified | 2026-09-11 | [→](https://github.com/techmonster-dev-org/tm-student-saivishalsai-c-systems/issues/13) |
...
| Declare pointer variables, use & and * to take addresses and dereference, handle NULL safely, and use pointer-to-pointer to pass pointers as output parameters. | ✅ Pass | ✅ Verified | 2026-09-01 | [→](https://github.com/techmonster-dev-org/tm-student-saivishalsai-c-systems/issues/9) |
...
| Explore array-to-pointer decay, pointer arithmetic, and null-terminated strings by implementing my_strlen and my_strcpy from scratch using only pointer operations. | ✅ Pass | ✅ Verified | 2026-09-11 | [→](https://github.com/techmonster-dev-org/tm-student-saivishalsai-c-systems/issues/12) |
