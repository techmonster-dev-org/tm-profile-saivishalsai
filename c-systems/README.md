...
|---|---|---|---|---|
| Write your first C program, trace the four-stage gcc compilation pipeline (preprocess/compile/assemble/link), and understand why C produces tiny, fast native binaries. | ⏳ Needs work | ⚠️ Unverified | 2026-08-24 | [→](https://github.com/techmonster-dev-org/tm-student-saivishalsai-c-systems/issues/2) |
...
| Explore C's fundamental types, use sizeof and <limits.h> to inspect platform sizes and bounds, use <stdint.h> fixed-width types, and understand why signed overflow is undefined behavior while unsigned wraparound is not. | ⏳ Needs work | ⚠️ Unverified | 2026-08-24 | [→](https://github.com/techmonster-dev-org/tm-student-saivishalsai-c-systems/issues/3) |
